...
//CHANGES: FORWARD THE TCP DATA. Responsible for managing the outgoing (to the network) transmission of TCP packets
...
public class TCPOutput implements Runnable
{
    ...
    private ConcurrentLinkedQueue<Packet> inputQueue; //A queue of packets received from the local device.
    private ConcurrentLinkedQueue<ByteBuffer> outputQueue; // Response packets?
