...
//This class represents an IP packet and encapsulates information
// about the packet's IP header, as well as optional TCP or UDP headers
// if the packet is of those types.
// TODO: Reduce public mutability
public class Packet
{

    //changes: currently i care only about the network level of the OSI layer
    public static final int IP4_HEADER_SIZE = 20;

    //changes: Probably TCP and UDP (Transport layer) will be used later when i want to specify from which app the packet comes from???
    ...
    //discuss Why would i need to swap source and destination? Why does this code do it? Don't i just intercept packets that come back and forth?
